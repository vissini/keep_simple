...
use Booglan\Config;
use Booglan\Number;
use Booglan\Preposition;
use Booglan\Verb;
use Booglan\Vocabulary;
...
// Check prepositions
$preposition = new Preposition($textA);
$prepositionA = $preposition->countPrepositions();
echo "Existem ".$prepositionA." preposições no texto A <br>";

$preposition = new Preposition($textB);
$prepositionB = $preposition->countPrepositions();
echo "Existem ".$prepositionB." preposições no texto B <hr>";

// Check Verbs
$verb = new Verb($textA);
$verbA = $verb->countVerbs();
echo "Há {$verbA['verbs']} verbos no texto A, dos quais {$verbA['first_person']} estão em primeira pessoa.<br>";

$verb = new Verb($textB);
$verbB = $verb->countVerbs();
echo "Há {$verbB['verbs']} verbos no texto B, dos quais {$verbB['first_person']} estão em primeira pessoa.<hr>";


// Check Beatifull Numbers
$number = new Number($textA);
$numberA = $number->totalOfNumbers();
echo "No Texto A, há $numberA números bonitos distintos (atenção!).<br>";

$number = new Number($textB);
$numberB = $number->totalOfNumbers();
echo "No Texto B, há $numberB números bonitos distintos (atenção!).<hr>";



$vocabulary = new Vocabulary($textA);
$vocabularyA = $vocabulary->showVocabulary();
echo "<b>Lista de vocabulário do Texto A</b><br>$vocabularyA<br><br><br>";

$vocabulary = new Vocabulary($textB);
$vocabularyB = $vocabulary->showVocabulary();
echo "<b>Lista de vocabulário do Texto B</b><br>$vocabularyB<br><br><br>";
